...
public class LoginPageController implements Initializable {
    ...
    public void onLogin() throws IOException {
        if (!EmailValidation.patternMatches(fieldUsername.getText())) {
            PopupWindowError.showErrorAlert(Alert.AlertType.ERROR, Constants.LOGIN_ERROR_EMAIL, Constants.LOGIN);
        } else {
